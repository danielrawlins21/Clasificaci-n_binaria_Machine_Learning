...
\input{sections/02_descripcion_dataset}
\input{sections/03_analisis_depuracion}
\input{sections/04_protocolo_experimental}
\input{sections/05_modelo_accuracy}
\input{sections/06_modelo_recall}
\input{sections/07_comparacion_global}
\input{sections/08_conclusiones}

\appendix
\input{sections/A1_apendice}
